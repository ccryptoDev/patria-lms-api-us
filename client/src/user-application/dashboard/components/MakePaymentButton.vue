...
<div>
    ...
    <div
        ...
        class="container"
        style="width: 40vw;height: 600px;overflow:auto;"
    >
        <h3>Make Payment</h3>
        <ValidationObserver v-slot="{ invalid }">
            <div class="row">
                <span v-if="paymentManagementData.canRunAutomaticPayment" class="disclaimer" style="margin-bottom:25px">
                    Disclaimer: Please note when AUTOPAY is <b>ON</b>, payments will always be carried out on the scheduled dates.
                ...
                <span v-else class="disclaimer" style="margin-bottom:25px">
                    Disclaimer: Please note when AUTOPAY is <b>OFF</b>, payments on the scheduled dates can be made starting from 30 days before each scheduled payment.
                    All additional payments outside the 30 day window will be counted towards the end of the scheduled payments.
                </span>
                <div
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            {{
                                previewResult.ledger.principalBalance + previewResult.ledger.paidPrincipalBalance | currency
                            }}
                            </td>
                        </tr>
                        <tr>
    ...
    <div v-if="disclaimerModal">
        ...
        <h3>Disclaimer</h3>
            <span v-if="paymentManagementData.canRunAutomaticPayment" class="disclaimer" style="margin-bottom:25px">
                Please note when AUTOPAY is <b>ON</b>, payments will always be carried out on the scheduled dates.
                All additional payments will be counted towards the end of the scheduled payments.
            </span>
            <span v-else class="disclaimer" style="margin-bottom:25px">
                Please note when AUTOPAY is <b>OFF</b>, payments on the scheduled dates can be made starting from 30 days before each scheduled payment.
                All additional payments outside the 30 day window will be counted towards the end of the scheduled payments.
            </span>
            <hr />
            <button
