    ...
    <div class="container">
      <div class="summary-row large-padding">
        <div class="summary-section">
          ...
          <div class="summary-row large-padding">
            <div class="summary-key width-40">Financing Reference Number</div>
            <div class="summary-value">{{ areferenceNumber }}</div>
          </div>
          <div class="summary-row large-padding">
            <div class="summary-key width-40">Interest Rate</div>
            <div class="summary-value">{{ selectedOffer.interestRate }}%</div>
          </div>
          <div class="summary-row large-padding">
            <div class="summary-key width-40">APR</div>
            <div class="summary-value">{{ selectedOffer.apr }}%</div>
          </div>
          <div class="summary-row large-padding">
            <div class="summary-key width-40">Term</div>
            <div class="summary-value">{{ convertMonthToWeek(selectedOffer.term) }} Weeks</div>
          </div>
          <!-- <div class="summary-row large-padding">
            <div class="summary-key width-40">Promo Term</div>
            <div class="summary-value">{{ selectedOffer.promoTerm }} Months</div>
          </div> -->
          <div class="summary-row large-padding">
            <div class="summary-key width-40">Next Payment Date</div>
            <div class="summary-value">
              {{ paymentManagementData.nextPaymentSchedule | date }}
            </div>
          </div>
...
export default Vue.extend({
  ...
  props: ['UserInfoData', 'DashboardData'],
  async created() {
    try {
      const {
        address,
  ...
  methods: {
    convertMonthToWeek(month: number) {
      if (month === 12) return 52;
      if (month === 9) return 39;
      if (month === 6) return 26;
    }
  },
});
</script>
