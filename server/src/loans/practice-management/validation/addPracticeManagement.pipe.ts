...
import AddPracticeManagementDto from './addPracticeManagement.dto';

@Injectable()
export class AddPracticeManagementPipe implements PipeTransform<any> {
  async transform(
    requestBody: AddPracticeManagementDto,
